...
\usepackage{makecell} % Cần thiết để xuống dòng trong ô bảng (Fix lỗi ReviewTable)


% =================================================================
% --- 10. NỘI DUNG CHÍNH --- [SỬ DỤNG CHANGELOG TỪ YAML]
% =================================================================
\onehalfspacing
\begin{document}
\maketitle 

% [Nếu bạn đã có \customTitle và ReviewTable, hãy xóa chúng]
...
\begin{longtable}{|p{0.08\textwidth}|p{0.22\textwidth}|p{0.14\textwidth}|p{0.12\textwidth}|p{0.16\textwidth}|p{0.12\textwidth}|}
    ...
    \hline
        1.0      &
    Khởi tạo tài liệu và phê duyệt lần đầu.  &
    KhoaND   &
    2025-01-01 &
    CEO/TienDD     &
    2025-01-05                                                                                                           \\
...
% ... (Chèn listoftables và listoffigures tại đây nếu bạn đã xóa chúng khỏi template) ...
